...
`AGENTS.md` defines the working method for AI agents. It does not replace `README.md`, and `README.md` does not replace the source-of-truth documents under `mobile/docs/` plus `docs/openapi.yaml`.

## Core Rule
`mobile/docs/` is the source of truth for mobile product scope, workflow, architecture, and implementation planning.
Use `docs/openapi.yaml` as the backend contract source of truth.
...
Agents may add other supporting documents under `mobile/docs/` when they improve clarity, planning, implementation, verification, operations, or handoff.

Recommended supporting documents include:
- `mobile/docs/architecture-decisions.md`
- `mobile/docs/testing-strategy.md`
- `mobile/docs/deployment-and-environment.md`
- `mobile/docs/security-and-access-model.md`
- `mobile/docs/integration-contracts.md`
- `mobile/docs/operational-runbook.md`
...
- Do not change workflow, approval, statuses, or user-visible behavior without updating the related mobile docs.
- Do not close a phase until verification has passed.
- Do not skip unresolved ambiguity; record it in `mobile/docs/open-questions-and-challenges.md`.

## Phase Discipline
Each phase in `mobile/docs/implementation-roadmap.md` must contain:
- objective
- source documents
- checklist
- output
...
Checklist items in `mobile/docs/implementation-roadmap.md` must not be marked complete unless their challenge/verification evidence is recorded.
...
- state whether `mobile/docs/implementation-roadmap.md` was updated
